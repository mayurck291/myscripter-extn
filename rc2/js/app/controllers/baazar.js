...
( function () {
  ...
  BaazarController = ( function () {
    ...
    BaazarController.$inject = [ '$scope', '$routeParams', '$timeout', '$route', 'Baazar', 'GPauth', 'Alert', 'Project' ];

    function BaazarController( scope, routeParams, timeout, route, Baazar, gp, Alert, Project ) {
      console.log( "to,epiu" )
      ...
      Baazar.get()
        .then( function ( recipes ) {
          console.log( "got resp", recipes );
          _this.scope.recipes = recipes;
        } );
      this.route = route;
      this.Baazar = Baazar;
    ...
    BaazarController.prototype.getStars = function ( range ) {
      ...
      if ( range != null ) {
        return ( function () {
            _results = [];
            for ( var _i = 1; 1 <= range ? _i <= range : _i >= range; 1 <= range ? _i++ : _i-- ) {
              _results.push( _i );
            }
            return _results;
          } )
    ...
    BaazarController.prototype.getRemStars = function ( range ) {
      ...
      if ( range === void 0 ) {
        ...
        return ( function () {
            _results = [];
            for ( var _i = range; range <= 5 ? _i <= 5 : _i >= 5; range <= 5 ? _i++ : _i-- ) {
              _results.push( _i );
            }
            return _results;
          } )
    ...
    BaazarController.prototype.karma = function ( recipe ) {
      var _this = this;
      this.Baazar.giveKarmaToRecipe( this.scope.user._id, recipe[ '_id' ][ '_id' ], this.scope.fm.karma, this.scope.fm.body )
        .then( function () {
    ...
    BaazarController.prototype.postComment = function ( recipe ) {
      var _this = this;
      return this.Baazar.postComment( recipe[ '_id' ][ '_id' ], this.scope.user._id, this.scope.cf.usercomment )
        .then( function () {
          var obj;
          obj = {
            user: {
    ...
    BaazarController.prototype.install = function ( recipeInfo ) {
      ...
      return this.Baazar.getRecipe( id )
