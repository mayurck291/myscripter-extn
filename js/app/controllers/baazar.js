...
BaazarController = (function() {
  ...
  BaazarController.prototype.karma = function(recipe) {
    this.Baazar.giveKarmaToRecipe(this.scope.user._id, recipe['_id']['_id'], this.scope.fm.karma, this.scope.fm.body).then((function(_this) {
      return function() {
  ...
  BaazarController.prototype.postComment = function(recipe) {
    return this.Baazar.postComment(recipe['_id']['_id'], this.scope.user._id, this.scope.cf.usercomment).then((function(_this) {
      return function() {
        var obj;
        obj = {
          user: {
  ...
  BaazarController.prototype.install = function(id) {
    ...
    return this.Baazar.getRecipe(id).then((function(_this) {
